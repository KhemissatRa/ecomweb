...
export default function Nav(){
     ...
     return (
<>
<div className=' bg-slate-200 	w-screen text-blue-800 flex justify-center space-x-16  text-base	 h-8 items-center	' >    
<div  style={{Color:'#30266C'}} className="flex  text-blue  fixed left-2"><h1 style={{color:"#E53BA4"}}>Kemissat</h1></div>
...
<form  style={{backgroundColor:'#E5CC6'}}  className=' fixed  right-2 m-auto flex'>
