    ...
    return (
        <section className="py-10  border border-t-gray-600 bg-white ">
            <div className="container mx-auto  px-4">
                <h2 className="text-3xl w-64 p-4  mx-auto text-gray-400 font-bold  mb-8 text-center ">Cooming Soon</h2>
                <div className=" flex flex-col  md:flex-row mx-auto space-y-2 justify-center items-center">

                    {products.map((item, index) => (
                        <div
                            key={index}
                            className=" flex flex-col justify-center items-center border bg-white  w-[300px]  border-gray-800 rounded-xl mx-4 p-10"
                        >
                            <img
